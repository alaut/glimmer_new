from glimmer.chewy import Gaussian, Mirror, Volume, solve, Plot
import numpy as np
...
source = Gaussian(w0, lam, num_waist=num_waist)
source.rotate_x(3, inplace=True, transform_all_input_vectors=True)
...
plotter = solve(source, optics, probes, prefix="./temp/chewy/mb")
plotter.show_grid()
plotter.show()
